...
const Details = () => {
  ...
  // Assume que o que virá é exatamente a Interface
  ...
  function handleWhatsapp() {
    return Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interesse em coleta de resíduos`)
  }
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.footer}>
        ...
        <RectButton style={[styles.button, { backgroundColor: 'blue' }]} onPress={handleComposeMail}>
